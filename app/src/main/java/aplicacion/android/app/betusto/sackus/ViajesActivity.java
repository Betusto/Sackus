...
public class ViajesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nowifibutton = findViewById(R.id.activity_viajes_nowifibutton);
        ...
        nowifibutton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                CD.mensajeNoInternet(ViajesActivity.this);
            }
        });

        mSectionsPagerAdapter = new ViajesActivity.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    ViajesTab1Crear Tab1 = new ViajesTab1Crear();
                    return Tab1;
                case 1:
                    ViajesTab2Mirar Tab2 = new ViajesTab2Mirar();
                    return Tab2;
                default:
                    return null;
            }
